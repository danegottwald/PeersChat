 ...
 *
 */
class PC_AudioHandler : public PC_Server, public PC_Client {
private:
	// Opus
...
protected:
	static char encodedAudio[MAX_NETPACKET_SIZE];
...
public:
	...
	// Getters
	char* getEncodedPacket();
	opus_int32 getEncodedFrameSize();
